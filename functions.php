...
if ( ! function_exists( 'ocaduillustration_scripts' ) ) {
  function ocaduillustration_scripts() {
    if ( ! is_admin() ) {
      ...
      wp_register_script( 'app', get_template_directory_uri() . '/assets/dist/app.js?1589846726', '', '2020', true );
...
function ocaduillustration_styles() {
  wp_register_style( 'ocadustyles', get_template_directory_uri() . '/assets/dist/main.css?1589846726', '', '2020' );
...
function ocaduillustration_get_socialimage( $image_type = 'fb' ) {
  ...
  if ( 'twitter-index' === $image_type ) {
    $socialimg = get_template_directory_uri() . '/thumb-twitter.jpg?1589846726';
  }

  if ( empty( $socialimg ) ) {
    $socialimg = get_template_directory_uri() . '/thumb.jpg?1589846726';
  }
