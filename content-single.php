<article <?php post_class(); ?> role="article">
		...
		<footer class="nav-single">
			...
			<nav id="nav-single">
				...
				<ul>
				<li class="nav-previous"><?php previous_post_link_plus( array('order_by' => 'post_title', 'format' => '%link', 'in_same_tax' => true, 'link' => '%title') ); ?></li>
				<li class="nav-next"><?php next_post_link_plus( array('order_by' => 'post_title', 'format' => '%link', 'in_same_tax' => true, 'link' => '%title') ); ?></li>
				</ul>
			</nav><!-- #nav-single -->
