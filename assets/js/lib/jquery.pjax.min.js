(function(b){function D(a,c,e){var d=this;return this.on("click.pjax",a,function(a){var f=b.extend({},l(c,e));f.container||(f.container=b(this).attr("data-pjax")||d);v(a,f)})}function v(a,c,e){e=l(c,e);c=a.currentTarget;if("A"!==c.tagName.toUpperCase())throw"$.fn.pjax or $.pjax.click requires an anchor element";if(!(1<a.which||a.metaKey||a.ctrlKey||a.shiftKey||a.altKey))if(!(location.protocol!==c.protocol||location.hostname!==c.hostname)&&!(c.hash&&c.href.replace(c.hash,"")===location.href.replace(location.hash,
