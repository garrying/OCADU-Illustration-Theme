...
function resize() {
  ...
  var leading = size * 0.5;
}

function addSlogan() {
  var x = 0;
  var y = 0; // Header offset
  ...
  for (var i = 0; i < copy.length; i++) {
    ...
    var rectangle = new Two.Rectangle(0, 0, 200, 50);
    ...
    Matter.Body.scale(entity, 200, 50);

    entity.scale = new Two.Vector(200, 50);
    entity.object = group;
